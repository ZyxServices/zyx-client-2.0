 ...
 * @since 2016/11/4
 */
public class LoginStrategy extends PointParamStrategy {
    @Override
    public UserPointParam buildPointParam(Integer userId, Long pointCount, String detailMsg) {
        ...
        userPointParam.setPointCount(100L);
        userPointParam.setDetailTable(PointConstants.TABLE_PANYAN);
        userPointParam.setDetailType(999);
        userPointParam.setDetailMsg(detailMsg + "用户第一次登陆赠送积分");
        userPointParam.setRuleParam(new UserPointRuleParam(3, 1));
